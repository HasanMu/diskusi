...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
        ->route('categories.index', compact('user'))->with('status', 'Data kategori berhasil ditambahkan!');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.index')->with('status', 'Data kategori berhasil diperbarui!');
    }
